// Tiny wrapper around Groq chat completions so API routes do not repeat fetch logic.
...
export async function createGroqChatCompletion({ model, messages, maxTokens = 600, temperature = 0.3, timeoutMs = 20000 }) {
  // This handles timeouts and response parsing once, then the meal/coach routes can reuse it.
