...
// Workouts screen.
// This page mixes starter routines with a builder for saving the user's own workouts.
...
export function WorkoutsScreen() {
  ...
  useEffect(() => {
    // Saved workouts live in Supabase, so we load them once the session is ready.
    if (!session) return
  ...
  const saveWorkout = async () => {
    // Creating a new saved workout costs a token, but editing an existing one does not.
