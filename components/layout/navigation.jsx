...
// Shared navigation for the protected app.
...
export function TopBar({ pageKey }) {
  // TopBar holds small global controls like theme, language, and token access.
...
export function BottomNav() {
  // BottomNav is the fast route switcher for the main app sections.
