...
// Dashboard screen.
// This page summarizes today's calories, macros, token status, weekly trend, and today's meals.
...
// Active plans are stored by billing period, so this formats a readable label for the dashboard cards.
...
export function DashboardScreen() {
  ...
  useEffect(() => {
    // The chart looks better when it includes the last few days, not just today's meals.
