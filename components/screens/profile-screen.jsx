...
// Profile screen.
// This page shows body stats, settings, token info, and the logout action.
...
export function ProfileScreen() {
  ...
  // Small helper so the edit form stays readable.
  const update = (key, value) => setForm((current) => ({ ...current, [key]: value }))

  const submit = async () => {
    // Saving profile also recalculates the calorie target from the new body stats.
    setSaving(true)
